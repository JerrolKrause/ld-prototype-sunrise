angular.module('sdpApp')
        ...
        .service('appDataSvc', function () {
          ...
          data.messages={Message:[{AddedBy:"	Teresa Howell",AddedByType:"Borrower",AddedOn:"2016-12-01T15:55:15.603",Msg:"Secure Document Exchange user 	Teresa Howell has requested a call back from you.  Please call back the borrower as soon as possible."},{AddedBy:"	Teresa Howell",AddedByType:"Borrower",AddedOn:"2016-12-01T15:54:30.867",Msg:"Can I use something else instead of a bankstatement>"},{AddedBy:"Mark Hansen",AddedByType:"LD Employee",AddedOn:"2016-11-22T10:47:37.363",Msg:"Please acknowledge viewing the following:"},{AddedBy:"Mark Hansen",AddedByType:"LD Employee",AddedOn:"2016-11-22T10:47:37.35",Msg:"Please sign the following:"},{AddedBy:"Mark Hansen",AddedByType:"LD Employee",AddedOn:"2016-11-22T10:42:19.657",Msg:"Please acknowledge viewing the following:"},{AddedBy:"Mark Hansen",AddedByType:"LD Employee",AddedOn:"2016-11-22T10:42:19.633",Msg:"Please sign the following:"},{AddedBy:"",AddedByType:"LD Employee",AddedOn:"2016-11-14T14:53:42.35",Msg:"Please acknowledge viewing the following:"},{AddedBy:"Mark Hansen",AddedByType:"Borrower",AddedOn:"2016-11-10T12:55:25.94",Msg:"Secure Document Exchange user Mark Hansen has requested a call back from you.  Please call back the borrower as soon as possible."},{AddedBy:"Mark Hansen",AddedByType:"Borrower",AddedOn:"2016-11-10T12:55:07.503",Msg:"Test"}]};
        var demoLoan = {
              borrowerSingle:"Teresa Howell",
              borrowers:["Teresa Howell", "Harvey Howell"],
              docs: [
